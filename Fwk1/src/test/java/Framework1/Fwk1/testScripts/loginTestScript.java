...
public class loginTestScript {
	...
	public void test() {
		...
		addNotePage.enterDescription("Example");
		addNotePage.clickOnAddNoteButton();
		Assert.assertTrue(Tools.verifyElement(driver, By.xpath("//h4[text()='Hola Mundo']")));
		Assert.assertTrue(Tools.verifyElement(driver, By.xpath("//p[text()='Example']")));
	}
